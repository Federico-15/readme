...
> 🎥 GitHub에서 README를 편집한 뒤, 이 안내 문구를 지우고 **HPA 영상**을 여기에 드래그 앤 드롭하세요.

<!-- HPA_VIDEO -->

##### GRU + KEDA — 예측형 오토스케일링

> 🎥 GitHub에서 README를 편집한 뒤, 이 안내 문구를 지우고 **KEDA 영상**을 여기에 드래그 앤 드롭하세요.
...
> 🎥 GitHub에서 README를 편집한 뒤, 이 안내 문구를 지우고 **On-prem Kubernetes, pfSense, PostgreSQL, CloudWatch, Alertmanager 통합 모니터링 영상**을 여기에 드래그 앤 드롭하세요.
