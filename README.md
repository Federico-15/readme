...
> 🎥 이 안내 문구를 지우고 **On-prem Kubernetes 모니터링 영상**을 여기에 드래그 앤 드롭하세요.

<!-- ON_PREM_KUBERNETES_VIDEO -->

##### 2. pfSense

> 🎥 이 안내 문구를 지우고 **pfSense 모니터링 영상**을 여기에 드래그 앤 드롭하세요.

<!-- PFSENSE_VIDEO -->

##### 3. PostgreSQL

> 🎥 이 안내 문구를 지우고 **PostgreSQL 모니터링 영상**을 여기에 드래그 앤 드롭하세요.

<!-- POSTGRESQL_VIDEO -->

##### 4. CloudWatch

> 🎥 이 안내 문구를 지우고 **CloudWatch 모니터링 영상**을 여기에 드래그 앤 드롭하세요.

<!-- CLOUDWATCH_VIDEO -->

##### 5. Alertmanager

> 🎥 이 안내 문구를 지우고 **Alertmanager 알림 모니터링 영상**을 여기에 드래그 앤 드롭하세요.

<!-- ALERTMANAGER_VIDEO -->

##### 6. Observability — Trace

> 🎥 이 안내 문구를 지우고 **분산 트레이싱(Observability Trace) 영상**을 여기에 드래그 앤 드롭하세요.

<!-- OBSERVABILITY_TRACE_VIDEO -->
